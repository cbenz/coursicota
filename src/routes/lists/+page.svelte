...
<section class="grid gap-6">
  ...
  <form method="POST" action="?/create" class="grid gap-3 md:max-w-xl md:grid-cols-[1fr_auto] md:items-end">
    <Field.Field>
  ...
  {:else}
    <Alert>
      ...
      <AlertDescription>Create your first list from the form above.</AlertDescription>
    </Alert>
  {/if}
</section>
